...
module MyOrg.Application.Plan (planCommand, planDemo) where
...
planCommand :: UTCTime -> [StoredEvent] -> Maybe OrgId -> Maybe UserId -> Command -> Either OrganizationError [StoredEvent]
